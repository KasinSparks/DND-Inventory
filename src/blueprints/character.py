...
def item_stat_query(item_id):
	fields = (
		"Items.Item_Str_Bonus", "Items.Item_Dex_Bonus", "Items.Item_Con_Bonus", "Items.Item_Int_Bonus",
		"Items.Item_Wis_Bonus", "Items.Item_Cha_Bonus", "Items.Item_Initiative_Bonus", "Items.Item_Health_Bonus",
...
def create_character_submit():
	...
	if request.method == 'POST':
		...
		if char_with_same_name is not None:
			error = "ERROR: You already have a character named " + char_with_same_name + " "
